...
<body class="body">		
		<div class="content">
			...
			<% try {
	            ...
	            String mySQLCode = " SELECT listing_id, make, model, mileage, color, price, description FROM dealership.listing JOIN dealership.make ON listing.make_id = make.make_id order by listing_id desc";
