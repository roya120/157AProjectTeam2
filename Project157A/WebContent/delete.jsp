...
<body class="body">		
		<div class="content">
			...
			try {
	            ...
	            String mySQLCode =  "DELETE FROM dealership.listing WHERE listing_id = "+listingID;
	            
	            stmt.executeUpdate(mySQLCode);
	            
 				mySQLCode =  "DELETE FROM dealership.make WHERE make_id = "+listingID;
